  ...
  const BADGE_DEFS = [
    ...
    },
    {
      ...
      story: { en: 'Every great starter deserves a name. Yours has one now.',
               es: 'Toda buena masa madre merece un nombre. La tuya ya tiene uno.' },
    },
    {
    ...
    },
    {
      ...
      story: { en: 'You completed the full Pancito tutorial. You know your starter, your tools, and your process. Now go bake.',
               es: 'Completaste el tutorial de Pancito. Ya conoces tu masa madre, tus herramientas y tu proceso. Ahora ve a hornear.' },
    },
    {
    ...
    },
    {
      ...
      story: { en: 'Thirty days. Your starter knows your schedule by now.',
               es: 'Treinta días. Tu masa madre ya conoce tu horario.' },
    },
    {
  ...
  const TIPS = [
    ...
    { id:'t02', cat:'starter',      icon:'science',
      ...
      body:    { en:'That grey liquid on top of your starter? That\'s hooch — alcohol from hungry yeast. Pour it off, feed your starter, and carry on. It means your starter is hungry, not dead.',
                 es:'¿Ese líquido grisáceo encima de tu masa madre? Es hooch — alcohol de levadura hambrienta. Tíralo, aliméntala y sigue adelante. Significa que tu masa madre tiene hambre, no que esté muerta.' } },
    ...
    { id:'t06', cat:'starter',      icon:'schedule',
      headline:{ en:'Feed your starter at the same time each day', es:'Alimenta tu masa madre a la misma hora cada día' },
      body:    { en:'Starters are creatures of habit. Consistent feeding times create consistent rise times — which means you can predict when your starter is at peak and plan your bake around it.',
                 es:'Las masas madre son criaturas de hábito. Los tiempos de alimentación consistentes crean tiempos de levada consistentes — lo que significa que puedes predecir cuándo tu masa madre está en su pico y planear tu horneada.' } },
    ...
    { id:'t13', cat:'starter',      icon:'opacity',
      ...
      body:    { en:'Feeding your starter 1 part starter : 2 parts flour : 2 parts water (by weight) gives the yeast plenty of fresh food and predicts a reliable rise. It\'s a great default until you learn your starter\'s personality.',
                 es:'Alimentar tu masa madre en proporción 1 parte masa madre : 2 partes harina : 2 partes agua (en peso) le da a la levadura bastante alimento fresco y predice una levada confiable. Es un buen punto de partida hasta que conozcas la personalidad de tu masa madre.' } },
    { id:'t14', cat:'flour',        icon:'eco',
      ...
      body:    { en:'Even 10–20% whole wheat flour added to your mix accelerates fermentation because it carries more wild yeast and bacteria from the bran. Great for cold kitchens or sluggish starters.',
                 es:'Agregar incluso un 10–20% de harina integral a tu mezcla acelera la fermentación porque lleva más levadura salvaje y bacterias del salvado. Ideal para cocinas frías o masas madre lentas.' } },
    ...
    { id:'t17', cat:'starter',      icon:'check_circle',
      ...
      body:    { en:'A ripe starter floats in water — but not always. Many bakers with perfectly healthy starters report their starters sinking. Rely more on the doubling time, the bubbles, and the dome. Float test is a bonus, not the rule.',
                 es:'Una masa madre madura flota en agua — pero no siempre. Muchos panaderos con masas madre perfectamente saludables reportan que las suyas se hunden. Confía más en el tiempo de doblado, las burbujas y el domo. La prueba del flotador es un extra, no la regla.' } },
    ...
    { id:'t20', cat:'flour',        icon:'bolt',
      headline:{ en:'Rye flour is a starter supercharger',         es:'La harina de centeno es un supercargador de masa madre' },
      body:    { en:'A tablespoon of rye flour in your starter feed accelerates activity because rye is packed with wild yeast and enzymes. Great for reviving a sluggish starter or when you want faster, more vigorous fermentation.',
                 es:'Una cucharada de harina de centeno en la alimentación de tu masa madre acelera la actividad porque el centeno está cargado de levaduras y enzimas. Ideal para revivir una masa madre lenta o cuando quieres una fermentación más vigorosa.' } },
    ...
    { id:'t27', cat:'starter',      icon:'thermostat',
      ...
      body:    { en:'Your starter behaves very differently at different temperatures. At 65°F it might peak in 10–12 hours. At 78°F it might peak in 4–6 hours. Learning this relationship is the key to predictable bakes.',
                 es:'Tu masa madre se comporta muy diferente a distintas temperaturas. A 65°F puede alcanzar su pico en 10–12 horas. A 78°F puede lograrlo en 4–6 horas. Aprender esta relación es la clave para horneadas predecibles.' } },
    ...
    { id:'t32', cat:'starter',      icon:'water',
      ...
      body:    { en:'Chlorinated tap water can inhibit yeast and bacteria in your starter. If your starter seems sluggish, try filtered water or leave tap water in an open container overnight to let chlorine off-gas.',
                 es:'El agua con cloro puede inhibir la levadura y las bacterias de tu masa madre. Si tu masa madre parece lenta, prueba con agua filtrada o deja el agua de la llave reposar en un recipiente abierto toda la noche para que el cloro se evapore.' } },
